 ...
 * Use the [BottomNaturalLanguageInput.newInstance] factory method to
...
class BottomNaturalLanguageInput : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment BottomNaturalLanguageInput.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BottomNaturalLanguageInput().apply {
